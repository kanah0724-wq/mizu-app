...
const s = {
  ...
  headerTitle:{ fontSize:16, fontWeight:"700", color:"#1a3a3f", letterSpacing:0.5 },
  ...
  arrowBtn:{ background:"rgba(255,255,255,0.7)", border:"1px solid rgba(158,219,232,0.5)",
    ...
    cursor:"pointer", display:"flex", alignItems:"center", justifyContent:"center" },
  monthLbl:{ fontSize:15, fontWeight:"600", color:"#1a3a3f" },
  ...
  summaryLbl:{ fontSize:12, color:"rgba(255,255,255,0.7)", margin:"0 0 4px" },
  ...
  cellLbl:{ fontSize:11, color:"rgba(255,255,255,0.75)", margin:"0 0 2px" },
  ...
  cardTitle:{ fontSize:14, fontWeight:"700", color:"#1a3a3f", margin:"0 0 12px" },
  emptyMsg:{ fontSize:13, color:"#7aacb5", textAlign:"center", padding:"14px 0" },
  ...
  txName:{ fontSize:13, fontWeight:"600", color:"#1a3a3f", margin:"0 0 3px" },
  catBadge:{ fontSize:10, background:"rgba(77,182,198,0.12)", color:"#006B78",
    borderRadius:6, padding:"1px 6px" },
  petBadge:{ fontSize:10, background:"rgba(126,224,193,0.18)", color:"#2a9d6e",
    borderRadius:6, padding:"1px 6px" },
  txAmt:{ fontSize:14, fontWeight:"700", margin:"0 0 2px" },
  txDate:{ fontSize:10, color:"#7aacb5", margin:0 },
  ...
  fieldLbl:{ fontSize:11, fontWeight:"700", color:"#4a7a80", letterSpacing:0.8, margin:"0 0 8px" },
  textInput:{ width:"100%", maxWidth:"100%", padding:"11px 14px", borderRadius:12,
    ...
    fontSize:14, color:"#1a3a3f", outline:"none", fontFamily:"inherit",
  ...
  ghostBtn:{ display:"block", width:"100%", padding:"16px 0", borderRadius:16,
    ...
    color:"#4a7a80", fontSize:15, fontWeight:"600", cursor:"pointer",
  ...
  payBadge:{ fontSize:10, background:"rgba(0,107,120,0.08)", color:"#4a7a80",
    borderRadius:6, padding:"1px 6px" },
